...
import 'package:siap_full/views/consultations/consultation.dart';
import 'package:siap_full/views/consultations/healthPoll.dart';
                              ...
                              Center(
                                child: IconButton(
                                  ...
                                  icon: Image.asset(
                                    ...
                                    color:
                                        value == 10 ? Color(0xFF2A6CD5) : null,
                                  ),
                                  onPressed: () {
                                    sync();
                                    saveValue(
