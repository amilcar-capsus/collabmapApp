...
import 'package:siap_full/views/surveys/surveys.dart';
import 'poll.dart';
...
//            DownloadMap(consultationId: widget.datos['id'],),
            ...
            Accion(
              ...
              height: MediaQuery.of(context).size.height * .1,
              texto:
                  Translations.of(context).text('acccomplaints').toUpperCase(),
              icono: 'accQuejas',
              elemento: null,
              accion: envConsult,
            ),
...
//    print('http://paraguay.collabmap.in/${lang}/consultation/${code}');
    var url =
        '$urlHtml/consultations/?acc=consultation&consultationId=${widget.datos['id']}';
